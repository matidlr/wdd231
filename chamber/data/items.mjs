export const items = [
  {
    ...
    address: "100 Main St, Cityville, ST 12345",
    description: "A beautiful 50-acre green space with walking trails, playgrounds, and seasonal community events.",
    image: "images/park.webp",
    alt: "Scenic view of Central City Park"
  },
  {
    name: "Historical Society Museum",
    address: "245 Heritage Way, Cityville, ST 12345",
    description: "Discover the local history, artifacts, and stories that shaped our vibrant community.",
    image: "images/museum.webp",
    alt: "Front facade of Historical Society Museum"
  },
  {
    name: "Riverfront Promenade",
    address: "500 River Rd, Cityville, ST 12345",
    description: "Enjoy scenic waterfront views, outdoor dining options, and local boutique shops along the river.",
    image: "images/riverfront.webp",
    alt: "Riverfront promenade at sunset"
  },
  {
  ...
  {
    name: "Farmer's Market Plaza",
    address: "75 Market Square, Cityville, ST 12345",
    description: "Weekly market featuring fresh local produce, artisanal goods, handcrafted crafts, and food trucks.",
    image: "images/market.webp",
    alt: "Bustling stalls at Farmer's Market Plaza"
  }
];